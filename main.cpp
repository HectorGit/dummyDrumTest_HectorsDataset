...
int main(void)
{
	...
	try
	{
		...
		data_set.set_data_file_name("data/smallerDataset.dat");
		...
		variables_pointer->set_name(1, "MFCC 1");
		variables_pointer->set_use(1, Variables::Input);

		variables_pointer->set_name(2, "MFCC 2");
		variables_pointer->set_use(2, Variables::Input);

		variables_pointer->set_name(3, "MFCC 5");
		variables_pointer->set_use(3, Variables::Input);

		variables_pointer->set_name(4, "MFCC 6");
		variables_pointer->set_use(4, Variables::Input);

		variables_pointer->set_name(5, "MFCC 7");
		variables_pointer->set_use(5, Variables::Input);

		variables_pointer->set_name(6, "MFCC 8");
		variables_pointer->set_use(6, Variables::Input);

		variables_pointer->set_name(7, "MFCC 9");
		variables_pointer->set_use(7, Variables::Input);

		variables_pointer->set_name(8, "MFCC 10");
		variables_pointer->set_use(8, Variables::Input);

		variables_pointer->set_name(9, "MFCC 11"); 
		variables_pointer->set_use(9, Variables::Input);

		variables_pointer->set_name(10, "Peak Ratio Chroma A");
		variables_pointer->set_use(10, Variables::Input);

		variables_pointer->set_name(11, "Zero Crossings"); 
		variables_pointer->set_use(11, Variables::Input);

		variables_pointer->set_name(12, "MFCC 0");
		variables_pointer->set_use(12, Variables::Input);

		variables_pointer->set_name(13, "Peak Ratio Chroma A 2"); //WTF
		variables_pointer->set_use(13, Variables::Input);

		variables_pointer->set_name(14, "Peak Ratio Minimum Chroma A");
		variables_pointer->set_use(14, Variables::Input);

		variables_pointer->set_name(15, "Centroid 2"); //WTF
		variables_pointer->set_use(15, Variables::Input);

		variables_pointer->set_name(16, "Rolloff");
		variables_pointer->set_use(16, Variables::Input);

		variables_pointer->set_name(17, "MFCC 10 2");
 		variables_pointer->set_use(17, Variables::Input); //WTF

		variables_pointer->set_name(18, "Centroid 3"); //WTF
		variables_pointer->set_use(18, Variables::Input);

		variables_pointer->set_name(19, "MFCC 0 3"); // WTF
